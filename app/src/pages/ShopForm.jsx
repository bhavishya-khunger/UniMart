    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center">
            <header className="flex flex-col items-center justify-center">
                ...
                <h1 className="font-bold mt-2 text-2xl text-center mb-8">Just a few steps away from setting up your shop!</h1>
            </header>
            <main>
                <InputVal value={shopName} onChange={(e) => setShopName(e.target.value)} fieldVal="Shop's Name" type="text" />
